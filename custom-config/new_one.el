...
(map!
 ...
 :desc "Jump to definition" "d" #'(mish/new-version-or-fallback #'lsp-ui-peek-find-definitions #'+lookup/documentation #'(lsp-feature? "textDocument/definition") #'(fboundp 'lsp-ui-peek-find-definitions))
 :desc "" "k" nil
